<template>
	<transition name="songlist">	
	  <div class="song-list" v-show="state" @click.self="close">
		...
		<div class="song-wrapper">
			<div class="content">
				<div class="list-con">
					<div class="songs">
						<ul>
							<li v-for="(song,k) in getSongList" :key="song.songid" :data-sid="song.songid" :class="{active:getSongList[getCurSongIndex].songid === song.songid}" @click="play(song.songmid,k)">
								<span class="song-name cur" v-text="song.songname"></span> 
